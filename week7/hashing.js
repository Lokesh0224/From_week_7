...
//during the signin endpoint first it will bring the salt from the database and then it will merge it with the user entered password now it will generate the hash, and then it check this hash with the exisiting hash in the db.  


//npm install bcrypt

//There are other hashing algorithm as well line sha256 or your own hashing algorithm